...
import { RmaDetailList, RmaListService, RmaLookupRequest } from './rma-list.service';
...
export class RmaListComponent implements OnInit {
  ...
  public allRMAListDetailedRows: RmaDetailList[];
  ...
  public rmaDetail = { rmaNumber: '', emailAddress: '' };
  // Public Methods
  // -----------------------------------------------------------------------------------------------------
   ...
   */
  constructor(private _datatablesService: RmaListService, private _coreSidebarService: CoreSidebarService) {
  ...
  public getRMADetails() {
    ...
    this._datatablesService
      .getRMALookup(this.rmaDetail.rmaNumber, this.rmaDetail.emailAddress)
      .pipe()
      .subscribe(
        data => {
  ...
  public getAllRMAs() {
    this._datatablesService
      ...
      .subscribe(
        data => {
          console.log(data);
          this.allRMAListDetailedRows = data;
          this.allRMAListRows = this.allRMAListDetailedRows;
