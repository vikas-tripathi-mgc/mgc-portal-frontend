...
export const menu: CoreMenu[] = [
    ...
    children: [
      {
        ...
        type: 'item', //? To set multiple role: ['Admin', 'Client']
        icon: 'circle',
      ...
      //   id: 'insight',
      //   title: 'Insight',
      //   translate: 'MENU.DASHBOARD.INSIGHT',
      //   type: 'item',
      //   icon: 'circle',
  ...
  // Repair and Return Service
  {
    ...
    translate: 'MENU.REPAIR_MANAGEMENT.SERVICE',
    icon: 'package',
    children: [
      {
        id: 'fault-case',
        title: 'Fault Cases',
        translate: 'MENU.REPAIR_MANAGEMENT.FAULT_CASE',
        type: 'collapsible',
        icon: 'tool',
        children: [
          {
            ...
            type: 'item',
            icon: 'circle',
            url: 'repair/fault-case/fault-list'
          },
          {
            id: 'fault-bulk-load',
            title: 'Bulk Load',
            translate: 'MENU.REPAIR_MANAGEMENT.BULK_FAULT_CASE',
            type: 'item',
            icon: 'circle',
            url: 'repair/fault-case/fault-bulk'
          }
        ]
      },
      {
        id: 'delivery-note',
        title: 'Delivery Note',
        translate: 'MENU.REPAIR_MANAGEMENT.DELIVERY_NOTE',
        type: 'collapsible',
        icon: 'file-text',
        children: [
          {
            ...
            type: 'item',
            icon: 'circle',
            url: 'repair/delivery-note/dn-list'
          },
          {
            id: 'dn-preview',
            title: 'Preview',
            ...
            type: 'item',
            icon: 'circle',
            url: 'repair/delivery-note/dn-preview'
          },
      ...
      },
      {
        id: 'rma-lookup',
        title: 'RMA',
        translate: 'MENU.REPAIR_MANAGEMENT.RMA_LOOKUP',
        type: 'item',
        icon: 'check-square',
        url: 'repair/rma-lookup/rma-list',
        badge: {
          title: 'ZEBRA',
      ...
      },
      {
        id: 'contract',
        title: 'Contract',
        translate: 'MENU.REPAIR_MANAGEMENT.CONTRACT_CHECK',
        type: 'item',
        icon: 'check-square',
        url: 'repair/contract-check/contract-list',
    ...
    children: [
      {
        ...
        type: 'item',
        icon: 'users',
        url: 'customer/customer-main/customer-list'
      },
      // {
      //   id: 'customer-devices',
      //   title: 'Devices',
      ...
      //   type: 'item',
      //   icon: 'tool',
      //   url: 'repair/customer/device-list',
  ...
  //       type: 'item',
  //       icon: 'users',
  //       url: 'customer-main/customer-list'
  //     },
